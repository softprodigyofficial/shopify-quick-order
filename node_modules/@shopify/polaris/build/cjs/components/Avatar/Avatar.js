...
function Avatar({
  ...
  const className = css.classNames(Avatar$1["default"].Avatar, size && Avatar$1["default"][css.variationName('size', size)], !customer && Avatar$1["default"][css.variationName('style', styleClass(nameString))], hasImage && status === Status.Loaded && Avatar$1["default"].imageHasLoaded);
