...
class DataTableInner extends PureComponent {
  ...
  render() {
    ...
    const fixedFirstColumn = condensed && hasFixedFirstColumn && /*#__PURE__*/React.createElement("table", {
    ...
    }, /*#__PURE__*/React.createElement("thead", null, /*#__PURE__*/React.createElement("tr", null, firstHeading.map((heading, index) => this.renderHeading({
      heading,
      headingIndex: index,
      inFixedFirstColumn: true,
      inStickyHeader: false
    }))), totals && !showTotalsInFooter && /*#__PURE__*/React.createElement("tr", null, firstTotal === null || firstTotal === void 0 ? void 0 : firstTotal.map(this.renderTotals))), /*#__PURE__*/React.createElement("tbody", null, firstColumn.map((row, index) => this.defaultRenderRow({
      row,
      index,
      inFixedFirstColumn: true
    ...
    const stickyHeaderMarkup = stickyHeader ? /*#__PURE__*/React.createElement(AfterInitialMount, null, /*#__PURE__*/React.createElement("div", {
      ...
      const stickyHeaderClassNames = classNames(styles.StickyTableHeader, isSticky && styles['StickyTableHeader-isSticky'], !isScrolledFarthestLeft && styles.separate);
      const fixedFirstStickyHeading = hasFixedFirstColumn ? /*#__PURE__*/React.createElement("table", {
        className: classNames(!isScrolledFarthestLeft && styles.separate, styles.FixedFirstColumn)
      }, /*#__PURE__*/React.createElement("thead", null, /*#__PURE__*/React.createElement("tr", null, this.renderHeading({
        heading: headings[0],
        headingIndex: 0,
        inFixedFirstColumn: true,
        inStickyHeader: true
      ...
      }, /*#__PURE__*/React.createElement("div", null, navigationMarkup), /*#__PURE__*/React.createElement("tr", {
    ...
    }), fixedFirstColumn, /*#__PURE__*/React.createElement("table", {
