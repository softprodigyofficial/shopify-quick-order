...
function Avatar({
  ...
  const className = classNames(styles.Avatar, size && styles[variationName('size', size)], !customer && styles[variationName('style', styleClass(nameString))], hasImage && status === Status.Loaded && styles.imageHasLoaded);
