...
:root { --polaris-version-number: '9.14.1'; }
...
@media (max-width: 40em) { .Polaris-Choice__Control { --p-choice-size: 1.375rem; } }
...
@media (max-width: 40em) { .Polaris-Choice__Descriptions { --p-choice-size: 1.375rem; } }
...
.Polaris-Checkbox__Backdrop { position: relative; border: var(--p-control-border-width) solid var(--p-border-subdued); background-color: var(--p-surface); border-radius: var(--p-border-radius-1); position: relative; display: block; width: 100%; height: 100%; position: relative; }
...
.Polaris-RadioButton__Backdrop { position: relative; top: 0; left: 0; display: block; width: 100%; height: 100%; border: var(--p-control-border-width) solid var(--p-border-subdued); border-radius: var(--p-border-radius-half); background-color: var(--p-surface); transition: border-color var(--p-duration-100) var(--p-ease); position: relative; }

@media (max-width: 40em) { .Polaris-RadioButton__Backdrop { --p-icon-size-small: 0.625rem; } }
...
.Polaris-DataTable__StickyHeaderEnabled .Polaris-DataTable__StickyTableHeader { position: absolute; display: flex; flex-direction: column; width: 100%; overflow: hidden; border-spacing: 0; }
...
.Polaris-DataTable__StickyHeaderEnabled .Polaris-DataTable__StickyTableHeadingsRow { overflow-x: auto; background-color: var(--p-surface); scrollbar-width: none; }
...
.Polaris-DataTable__FixedFirstColumn { position: absolute; background: var(--p-surface); z-index: 3; border-spacing: 0; }

@media (max-width: 48em) { .Polaris-DataTable__FixedFirstColumn { z-index: 1; } }

.Polaris-DataTable__FixedFirstColumn.Polaris-DataTable--separate th { border-right: var(--p-border-divider); }
...
@media (min-width: 30em) { .Polaris-Grid-Cell { grid-row: var(--pc-row-sm); grid-column: var(--pc-column-sm); } }
...
@media (min-width: 30em) { .Polaris-Grid-Cell--cell_1ColumnSm { grid-column-end: span 1; }
...
@media (min-width: 30em) { .Polaris-Grid { gap: var(--pc-grid-gap-sm, var(--p-space-4)); grid-template-areas: var(--pc-grid-areas-sm); grid-template-columns: repeat(var(--pc-grid-columns-sm), minmax(0, 1fr)); } }
...
.Polaris-OptionList-Checkbox__Backdrop { position: relative; border: var(--p-control-border-width) solid var(--p-border-subdued); background-color: var(--p-surface); border-radius: var(--p-border-radius-1); position: relative; display: block; width: 100%; height: 100%; position: relative; }
